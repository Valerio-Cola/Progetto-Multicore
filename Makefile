...
MPICUDAFLAGS=-arch=sm_75 -I/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi -I/usr/lib/x86_64-linux-gnu/openmpi/include -lmpi

# Targets to build
OBJS=align_seq align_omp align_mpi align_cuda align_mpi_cuda
...
help:
	...
	@echo "make align_mpi_cuda	Build only the MPI+CUDA version"
	@echo
...
align_mpi_cuda: align_mpi_cuda.cu rng.c
	$(CUDACC) $(CUDAFLAGS) $(MPICUDAFLAGS) $(DEBUG) $< $(LIBS) -o $@
